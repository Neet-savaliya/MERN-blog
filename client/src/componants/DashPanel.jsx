...
export default function DashPanel() {
    ...
    const [recentPost, setRecentPosts] = useState(0);
    const [recentComment, setRecentComment] = useState(0);
    const [recentUser, setRecentUsers] = useState(0);
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            ...
            if (res.ok) {
                ...
                setUsers(data.users);
                setRecentUsers(data.lastMonthUsers);
        ...
        const fetchComments = async () => {
            ...
            if (res.ok) {
                ...
                setRecentComment(data.lastMonthComment);
        ...
        const fetchPosts = async () => {
            ...
            if (res.ok) {
                const data = await res.json();
                setPosts(data.post);
                setRecentPosts(data.lastMonthPost);
                setTotalPost(data.totalPost);
            }
        };

        if (currentUser.payload.admin === true) {
            fetchUsers();
            fetchComments();
            fetchPosts();
        }
